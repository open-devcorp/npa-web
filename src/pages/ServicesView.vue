<template>
    ...
    <section class="py-4 max-w-screen-xl mx-auto px-4 xl:px-0 gap-32 mt-10">
        ...
        <SectionTitle title="SERVICIOS" textColor="text-tertiary" />
          ...
          <ServiceCard
            imageSrc="../assets/images/about-business-woman.png"
            imageAlt="Imagen 1"
  ...
  <section class="relative overflow-hidden bg-white">
    ...
    <SectionTitle title="NUESTRAS ALIANZAS" textColor="text-white" class="relative text-lg md:text-xl font-mont-black text-white py-4 max-w-screen-xl mx-auto px-4  mt-10" />
