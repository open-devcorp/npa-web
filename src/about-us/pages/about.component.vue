  ...
  <div class="bg-noise-white">
    ...
    <section class="bg-noise-blue text-white py-15 md:py-20 lg:py-25">
      <div class="max-w-7xl mx-auto px-4 text-center">
        <h1 class="font-mont-heavy text-4xl md:text-7xl mb-6">Nosotros</h1>
        <p class="font-public-sans font-black text-sm">
          <span class="text-secondary font-public-sans font-black">INICIO</span> / NOSOTROS
        </p>
      </div>
    </section>
        ...
        <div class="flex flex-col md:gap-6 gap-4 lg:gap-8">
          ...
          <div class="flex flex-col md:flex-row gap-8 lg:gap-32">
            <div class="flex flex-col w-full md:w-1/2">
              <p class="text-4xl md:text-5xl xl:text-7xl font-mont-regular lg:whitespace-nowrap">Somos un</p>
              <p class="text-4xl md:text-5xl xl:text-7xl font-mont-heavy lg:whitespace-nowrap">punto de encuentro
              </p>
            </div>
            <div class="flex flex-col w-full md:w-1/2">
    ...
    <section class="pb-24">
      <div class="max-w-screen-xl mx-auto px-4 xl:px-0">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:flex justify-center gap-6 -mt-12 lg:-mt-24 z-10">
          <AboutCard title="Equipo Interdisciplinario"
          ...
          <AboutCard title="Catalizadores del Éxito"
          ...
          <div class="sm:col-span-2 lg:col-span-1 justify-self-center">
            <AboutCard title="Acceso Estratégico"
              ...
              animation-class="animate-slide-right delay-300" :card-index="2"
      ...
      <div class="max-w-screen-xl mx-auto px-4 xl:px-0">
        ...
        <div class="flex flex-col md:flex-row gap-8">
          ...
          <div class="w-full flex flex-col gap-6 md:gap-8">
            <ObjectiveCard title="Nuestra misión"
            ...
            <ObjectiveCard title="Nuestra visión"
