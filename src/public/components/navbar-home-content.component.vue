<template>
    <nav class="max-w-screen-xl mx-auto px-8 xl:px-0 mt-8 absolute top-0 left-0 right-0 z-50">
        <div class="flex justify-between items-center">
            <router-link to="/">
            <img src="/src/assets/icons/logo-home-npa.webp" 
                alt="Logo NPA"
                class="w-30 md:w-35 lg:w-40 object-contain" />
